...
import { View, Text, StyleSheet, useWindowDimensions, ScrollView, Platform, Image, ImageStyle, StyleProp } from "react-native";
...
export function FeatureCard({ icon, title, description, variant = "primary" }: FeatureCardProps) {
...
export function ResponsiveImage({ source, style }: ResponsiveImageProps) {
  ...
  return (
    <View style={[styles.imageContainer, { width }]}>
      <Image source={source} style={[styles.image, { aspectRatio }, style]} resizeMode="cover" />
    </View>
  );
}
